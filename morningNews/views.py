...
from homepage.models import SelectedUrls
...
def news(request):
    ...
    for email in mail:
        ...
        html_message = render_to_string('morning_news.html',{'blogs':letest,'email':email,'heading':new,'urls':urls})
        plain_message = strip_tags(html_message)
        send_mail(subject, plain_message, 'royell4912@gmail.com', [email], html_message=html_message)
    return HttpResponse('<div style="text-align: center; margin: 17rem;">Daily News Invited <br> <a href="'+ urls +'" style="margin:1rem;" type="submit"> Return to home </a></div>')